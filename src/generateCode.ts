...
export function generateCode(
  ...
  sb.push("    /// called in one of the following ways:\n")
  sb.push("    ///\n")
  sb.push("    /// - `@as(?Proc, loader(@as([*:0]const u8, prefixed_name)))`\n")
  sb.push("    /// - `@as(?Proc, loader.getProcAddress(@as([*:0]const u8, prefixed_name)))`\n")
  sb.push("    ///\n")
  ...
  sb.push("        const proc_opt: ?Proc = if (loader_is_fn)\n")
