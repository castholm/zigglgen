...
export function generateCode(features: ResolvedFeatures, apiVersionProfile: string): string {
  ...
  sb.push(NOTICE)
  sb.push("\n")
  sb.push(`//! Zig binding for ${apiVersionProfile}.\n`)
  sb.push(`//!\n`)
  sb.push(`//! Generated by [zigglgen ${ZIGGLGEN_VERSION}](${ZIGGLGEN_URL}) at ${timestamp}.\n`)
  sb.push("\n")
  sb.push("/// The API targeted by the OpenGL binding.\n")
  sb.push("pub const api = struct {\n")
  sb.push(`    pub const name = "${apiVersionProfile}";\n`)
  sb.push(`    pub const version_major = ${versionMajor};\n`)
  sb.push(`    pub const version_minor = ${versionMinor};\n`)
  sb.push("};\n")
  sb.push("\n")
