...
// OpenGL XML API Registry revision: ca491a0576d5c026f06ebe29bfac7cbbcf1e8332
...
pub fn GenFramebuffers(n: sizei, framebuffers: [*c]uint) void {
    return ProcTable.current.?.GenFramebuffers(n, framebuffers);
}
pub fn GenQueries(n: sizei, ids: [*c]uint) void {
    return ProcTable.current.?.GenQueries(n, ids);
}
pub fn GenRenderbuffers(n: sizei, renderbuffers: [*c]uint) void {
    return ProcTable.current.?.GenRenderbuffers(n, renderbuffers);
}
pub fn GenSamplers(count: sizei, samplers: [*c]uint) void {
    return ProcTable.current.?.GenSamplers(count, samplers);
}
pub fn GenTextures(n: sizei, textures: [*c]uint) void {
    return ProcTable.current.?.GenTextures(n, textures);
}
pub fn GenTransformFeedbacks(n: sizei, ids: [*c]uint) void {
...
pub fn GetProgramInfoLog(program: uint, bufSize: sizei, length: [*c]sizei, infoLog: [*c]char) void {
...
pub fn GetShaderInfoLog(shader: uint, bufSize: sizei, length: [*c]sizei, infoLog: [*c]char) void {
    return ProcTable.current.?.GetShaderInfoLog(shader, bufSize, length, infoLog);
}
pub fn GetShaderPrecisionFormat(shadertype: @"enum", precisiontype: @"enum", range: [*c]int, precision: [*c]int) void {
    return ProcTable.current.?.GetShaderPrecisionFormat(shadertype, precisiontype, range, precision);
}
pub fn GetShaderSource(shader: uint, bufSize: sizei, length: [*c]sizei, source: [*c]char) void {
...
pub fn ShaderSource(shader: uint, count: sizei, string: [*c]const [*c]const char, length: [*c]const int) void {
    return ProcTable.current.?.ShaderSource(shader, count, string, length);
}
...
pub const ProcTable = struct {
    ...
    DeleteBuffers: *const fn (n: sizei, buffers: [*c]const uint) callconv(APIENTRY) void,
    ...
    GenBuffers: *const fn (n: sizei, buffers: [*c]uint) callconv(APIENTRY) void,
    GenFramebuffers: *const fn (n: sizei, framebuffers: [*c]uint) callconv(APIENTRY) void,
    GenQueries: *const fn (n: sizei, ids: [*c]uint) callconv(APIENTRY) void,
    GenRenderbuffers: *const fn (n: sizei, renderbuffers: [*c]uint) callconv(APIENTRY) void,
    GenSamplers: *const fn (count: sizei, samplers: [*c]uint) callconv(APIENTRY) void,
    GenTextures: *const fn (n: sizei, textures: [*c]uint) callconv(APIENTRY) void,
    GenTransformFeedbacks: *const fn (n: sizei, ids: [*c]uint) callconv(APIENTRY) void,
    GenVertexArrays: *const fn (n: sizei, arrays: [*c]uint) callconv(APIENTRY) void,
    ...
    GetProgramInfoLog: *const fn (program: uint, bufSize: sizei, length: [*c]sizei, infoLog: [*c]char) callconv(APIENTRY) void,
    GetProgramiv: *const fn (program: uint, pname: @"enum", params: [*c]int) callconv(APIENTRY) void,
    ...
    GetShaderInfoLog: *const fn (shader: uint, bufSize: sizei, length: [*c]sizei, infoLog: [*c]char) callconv(APIENTRY) void,
    GetShaderPrecisionFormat: *const fn (shadertype: @"enum", precisiontype: @"enum", range: [*c]int, precision: [*c]int) callconv(APIENTRY) void,
    GetShaderSource: *const fn (shader: uint, bufSize: sizei, length: [*c]sizei, source: [*c]char) callconv(APIENTRY) void,
    GetShaderiv: *const fn (shader: uint, pname: @"enum", params: [*c]int) callconv(APIENTRY) void,
    ...
    pub fn init(procs: *ProcTable, locator: anytype) bool {
        ...
        if (procs.initExtension("EXT_clip_control")) {
            _ = procs.initCommand(locator, "ClipControlEXT");
        }
        if (procs.initExtension("NV_scissor_exclusive")) {
            _ = procs.initCommand(locator, "ScissorExclusiveArrayvNV");
            _ = procs.initCommand(locator, "ScissorExclusiveNV");
        }
        return true;
    }
