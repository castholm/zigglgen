...
function main {
    ...
    try {
        ...
        processZigglgenOptions $registry $rev | zig fmt --stdin | Set-Content zigglgen_options.zig
        zig test zigglgen_options.zig
    } finally {
...
function processZigglgenOptions ([System.Xml.XmlElement] $registry, [string] $rev) {
    "// This file was generated by '$scriptName'."
    "// OpenGL XML API Registry revision: $rev"
    ''
